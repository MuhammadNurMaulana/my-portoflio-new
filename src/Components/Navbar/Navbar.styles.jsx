...
export const Header = (props) => {
  ...
  return (
    <div className={`flex items-center lg:flex-col gap-x-4 lg:gap-4 lg:items-start  ${classname}`}>
      <div className="w-14 h-14 md:w-16 md:h-16 lg:w-24 lg:h-24 rounded-full overflow-hidden relative bg-slate-800 dark:bg-slate-400">
        <div className="absolute -top-10 w-14 h-14 md:w-16 md:h-16 lg:w-24 lg:h-24 rounded-full bg-slate-600 dark:bg-slate-200 "></div>
        <img src={myImage} alt="My Profile" className="w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 z-20 relative" />
      </div>

      <div className="flex items-center">
        <div>
          <h1 className="font-sans text-sm font-bold md:text-lg lg:text-xl lg:font-bold">
            Muhammad <div className="hidden md:inline-block">Nur Maulana</div>
          </h1>
          <h1 className="md:hidden font-sans text-sm font-bold">Nur Maulana</h1>
        </div>
